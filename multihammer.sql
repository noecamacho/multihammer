...
insert  into `acceso`(`id_perfil`,`id_modulo`) values (2,1),(1,5),(1,4),(1,2),(1,3),(1,1),(1,6),(1,7),(1,8),(2,7),(2,8),(1,9);
...
insert  into `materiales`(`id_material`,`material`,`descripcion`) values (1,'Piso Rojo','Un piso rojo pasión'),(2,'Varilla','Varilla normal'),(3,'Piso','Un piso más'),(4,'algo','algo'),(13,'prueba','asdsadsa'),(14,'adasda','asdasdsaas'),(15,'iopipo','asdasdass'),(16,'Cemento','Cemento duradero');
...
insert  into `modulos`(`id_modulo`,`nombre`,`estado`) values (1,'Productos',1),(2,'Reportes',1),(3,'Estadisticas',1),(4,'Usuarios',1),(5,'Modulos',1),(6,'Proveedores',1),(7,'Ventas',1),(8,'Clientes',1),(9,'Pedidos',1);
...
insert  into `productos`(`id_producto`,`id_material`,`unidad`,`precio`,`id_proveedor`,`cantidad`,`existencia`) values (1,1,'pz',65.99,2,46,1),(2,1,'m²',75.25,2,45,1),(3,1,'pz',70.00,1,23,1),(4,2,'m',10.00,2,670,1),(5,3,'pz',20.00,3,300,1),(6,1,'m²',210.00,1,8,0),(21,15,'m',123.00,2,91,0),(22,16,'Saco 20KG',50.00,1,28,1);
...
insert  into `proveedores`(`id_proveedor`,`domicilio`,`rfc`,`razon_social`,`estado`,`telefono`) values (1,'Rio Presidio','MELM8305281H0','Provisa',0,'6691238459'),(2,'Mazatlan','UEPS123632KSJ','UPSIN',1,'6692847232'),(3,'Mazatlan','KALO210298AL3','Kuroda',1,'5582918237');
